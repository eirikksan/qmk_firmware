...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_split_3x6_3(
    KC_ESC,  XXXXXXX, KC_UP,   XXXXXXX, XXXXXXX, XXXXXXX,                       NO_PLUS, KC_7, KC_8, KC_9, XXXXXXX, XXXXXXX,
    KC_LSFT, KC_LEFT, KC_DOWN, KC_RIGHT,XXXXXXX, NO_BSLS,                       NO_MINS, KC_4, KC_5, KC_6, XXXXXXX, XXXXXXX,
    KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, NO_SLSH,                       KC_0, KC_1, KC_2, KC_3,XXXXXXX, KC_DEL,
  ...
  [2] = LAYOUT_split_3x6_3(
    ...
    KC_LCTL, XXXXXXX, XXXXXXX, XXXXXXX, NO_LABK, NO_DQUO,                       NO_UNDS, NO_RPRN, NO_RBRC, NO_RCBR, NO_PIPE, KC_BSPC,
